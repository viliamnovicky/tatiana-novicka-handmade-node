...
var showAlert = function showAlert(type, msg) {
  ...
  var markup = "<div class=\"alert alert__".concat(type, "\">").concat(msg, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, time * 1000);
};
exports.showAlert = showAlert;
},{}],"handleProducts.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateProduct = exports.createNewProduct = void 0;
...
var createNewProduct = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') console.log(res.data.status, "yupiii");
          (0, _alerts.showAlert)('success', 'Produkt úspešne pridaný do databázy', 5);
        ...
        case 10:
          ...
          (0, _alerts.showAlert)('error', 'Niečo sa nepodarilo', 5);
        case 13:
        case "end":
  ...
  return function createNewProduct(_x) {
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id, data) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') (0, _alerts.showAlert)('success', 'Informácie o produkte úspešne zmenené', 5);
          window.setTimeout(function () {
            location.assign("/produkty/".concat(category, "/").concat(id));
          }, 500);
          _context2.next = 11;
          break;
        case 8:
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createNewCategory.js":[function(require,module,exports) {
"use strict";
...
var createNewCategory = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          console.log(res.data.status);
          if (res.data.status === 'success') console.log(res.data.status, "yupiii");
          (0, _alerts.showAlert)('success', 'Kategória úspešne pridaný do databázy', 5);
          window.setTimeout(function () {
            location.assign('/novy-produkt');
          }, 500);
          _context.next = 13;
  ...
  return function createNewCategory(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.createNewCategory = createNewCategory;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"helpers.js":[function(require,module,exports) {
"use strict";
...
var closeModal = function closeModal() {
  ...
  var modalDynamic = document.querySelector(".modal__dynamic");
  var modalStatic = document.querySelector(".modal__static");
...
},{}],"markups.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createModalLoginMarkup = void 0;
var modalDynamic = document.querySelector(".modal__dynamic");
var modalStatic = document.querySelector(".modal__static");
var createModalLoginMarkup = function createModalLoginMarkup() {
  modalDynamic.classList.add("modal__small");
  modalStatic.classList.add("modal__small");
  modalDynamic.insertAdjacentHTML("beforeend", "\n    <h3 class=\"title__header\">Prihl\xE1senie</h3>\n    <img class = \"img img__login-blob\" src=\"/img/blob-login.svg\"></img>\n    <form class = \"form form__login\">\n        <label for=\"name\">meno</label>\n        <input id=\"name\" type=\"text\" name=\"name\">\n        <label for=\"password\">heslo</label>\n        <input id=\"password\" type=\"password\" name=\"password\">\n        <button class=\"btn btn__primary\" id=\"login-btn\">prihl\xE1si\u0165</button>\n    </form>\n    ");
};
exports.createModalLoginMarkup = createModalLoginMarkup;
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, password) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Prihlásenie prebehlo úspešne');
            window.setTimeout(function () {
              location.reload();
            }, 500);
          }
...
var displayMap = function displayMap() {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmlsaWFtbm92aWNreSIsImEiOiJjbGVlazBvcWYwaHVjM3ZtajZveGoxM244In0.hnpQA34MhL9qxzfDOcUd2g';
...
var _alerts = require("./alerts");
var _createNewCategory = require("./createNewCategory");
...
// CLOSE MODAL
document.querySelector(".btn__close").addEventListener("click", _helpers.closeModal);

//LOGIN
if (document.querySelector(".btn__login")) {
  document.querySelector(".btn__login").addEventListener("click", function (e) {
    e.preventDefault();
    (0, _helpers.showModal)();
    (0, _markups.createModalLoginMarkup)();
  });
}
...
if (document.getElementById("btn-upload-item")) {
  var newItemForm = document.querySelector('.form__new-item');
  newItemForm.addEventListener("submit", function (e) {
    ...
    var i = document.getElementById('productImages').files.length;
    for (var x = 0; x < i; x++) {
      form.append("productImages", document.getElementById('productImages').files[x]);
    }
    console.log(document.getElementById('name').value);
    (0, _handleProducts.createNewProduct)(form);
  });
}

// UPDATE PRODUCT
if (document.getElementById("btn-update-product")) {
  var id = document.querySelector('.form__new-item').id;
  var productForm = document.querySelector('.form__new-item');
  productForm.addEventListener("submit", function (e) {
    ...
    if (document.getElementById('coverImage').files[0]) form.append('coverImage', document.getElementById('coverImage').files[0]);
    var i = document.getElementById('productImages').files.length;
    for (var x = 0; x < i; x++) {
      form.append("productImages", document.getElementById('productImages').files[x]);
    }
    (0, _handleProducts.updateProduct)(id, form);
  });
}

// CREATE NEW CATEGORY
if (document.getElementById("btn-upload-category")) {
  var newCategoryForm = document.querySelector(".form__new-category");
